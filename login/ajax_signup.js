...
var directionSelect = $('#id_direction')
directionSelect.defHTML = directionSelect.html();

var specialitySelect = $('#id_speciality')
specialitySelect.defHTML = specialitySelect.html();

var lformSelect = $('#id_learnform')
lformSelect.defHTML = lformSelect.html();
...
linkSelects(filialSelect,       directionSelect,    function (id) { return {action: 'listdirections', filial:id} });
linkSelects(directionSelect,    specialitySelect,   function (id) { return {action: 'listspecialities', direction:id} });
linkSelects(specialitySelect,   lformSelect,        function (id) { return {action: 'listlearnforms', speciality:id} });
linkSelects(lformSelect,        fioSelect,          function (id) { return {action: 'listfio', learnform:id} });
