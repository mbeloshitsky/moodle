...
class login_signup_form extends moodleform {
	...
	$filials = array();
        $default_filial[''] = get_string('selectafilial');
        $filial = array_merge($default_filial, $filials);
        $mform->addElement('select', 'filial', get_string('filial'), $filials);
        $mform->addRule('filial', get_string('missingfilial'), 'required', null, 'server');

        $mform->addElement('select', 'direction', get_string('direction'), get_string('select_direction'), 'disabled');
        $mform->addRule('direction', get_string('missingdirection'), 'required', null, 'server');

        $mform->addElement('select', 'speciality', get_string('speciality'), get_string('select_speciality'), 'disabled');
        $mform->addRule('speciality', get_string('missingspeciality'), 'required', null, 'server');

        $mform->addElement('select', 'learnform', get_string('learnform'), get_string('select_learnform'), 'disabled');
