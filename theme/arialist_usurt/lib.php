...
function arialist_usurt_process_css($css, $theme) {
    ...
    $css = arialist_usurt_set_linkcolor($css, $linkcolor);
    ...
    $css = arialist_usurt_set_regionwidth($css, $regionwidth);
    ...
    $css = arialist_usurt_set_customcss($css, $customcss);
 ...
 * @return string
 */
function arialist_usurt_set_linkcolor($css, $linkcolor) {
...
function arialist_usurt_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function arialist_usurt_set_customcss($css, $customcss) {
